 ...
 * Service version: 0.2.7
 * apibuilder 0.14.3 app.apibuilder.io/gilt/svc-sundial/0.2.7/play_2_x_json
 */
package com.gilt.svc.sundial.v0.models {
  ...
  object EmrReleaseLabel {
     ...
     * above.
     */
    val all: scala.List[EmrReleaseLabel] = scala.List(Emr5140, Emr5130, Emr5121, Emr5120, Emr5111, Emr5110, Emr5100, Emr590, Emr492, Emr491)
  ...
  package object json {
    ...
    implicit def jsonReadsSvcSundialBatchImageCommand: play.api.libs.json.Reads[BatchImageCommand] = {
      for {
        ...
        environmentVariables <- (__ \ "environment_variables").read[Seq[com.gilt.svc.sundial.v0.models.EnvironmentVariable]]
    ...
    implicit def jsonReadsSvcSundialEmail: play.api.libs.json.Reads[Email] = {
      for {
        ...
        notifyWhen <- (__ \ "notify_when").read[com.gilt.svc.sundial.v0.models.NotificationOptions]
    ...
    implicit def jsonReadsSvcSundialEmrCommand: play.api.libs.json.Reads[EmrCommand] = {
      for {
        emrCluster <- (__ \ "emr_cluster").read[com.gilt.svc.sundial.v0.models.EmrCluster]
        ...
        s3LogDetails <- (__ \ "s3_log_details").readNullable[com.gilt.svc.sundial.v0.models.S3LogDetails]
        loadData <- (__ \ "load_data").readNullable[Seq[com.gilt.svc.sundial.v0.models.S3Cp]]
        saveResults <- (__ \ "save_results").readNullable[Seq[com.gilt.svc.sundial.v0.models.S3Cp]]
    ...
    implicit def jsonReadsSvcSundialEmrInstanceGroupDetails: play.api.libs.json.Reads[EmrInstanceGroupDetails] = {
      for {
        ...
        awsMarket <- (__ \ "aws_market").read[com.gilt.svc.sundial.v0.models.AwsMarket]
    ...
    implicit def jsonReadsSvcSundialNewEmrCluster: play.api.libs.json.Reads[NewEmrCluster] = {
      for {
        name <- (__ \ "name").read[String]
        releaseLabel <- (__ \ "release_label").read[com.gilt.svc.sundial.v0.models.EmrReleaseLabel]
        applications <- (__ \ "applications").read[Seq[com.gilt.svc.sundial.v0.models.EmrApplication]]
        s3LogUri <- (__ \ "s3_log_uri").read[String]
        masterInstance <- (__ \ "master_instance").read[com.gilt.svc.sundial.v0.models.EmrInstanceGroupDetails]
        coreInstance <- (__ \ "core_instance").readNullable[com.gilt.svc.sundial.v0.models.EmrInstanceGroupDetails]
        taskInstance <- (__ \ "task_instance").readNullable[com.gilt.svc.sundial.v0.models.EmrInstanceGroupDetails]
        ec2Subnet <- (__ \ "ec2_subnet").readNullable[String]
        emrServiceRole <- (__ \ "emr_service_role").read[com.gilt.svc.sundial.v0.models.EmrServiceRole]
        emrJobFlowRole <- (__ \ "emr_job_flow_role").read[com.gilt.svc.sundial.v0.models.EmrJobFlowRole]
        visibleToAllUsers <- (__ \ "visible_to_all_users").read[Boolean]
      } yield NewEmrCluster(name, releaseLabel, applications, s3LogUri, masterInstance, coreInstance, taskInstance, ec2Subnet, emrServiceRole, emrJobFlowRole, visibleToAllUsers)
    }
    ...
    implicit def jsonReadsSvcSundialProcess: play.api.libs.json.Reads[Process] = {
      for {
        ...
        status <- (__ \ "status").read[com.gilt.svc.sundial.v0.models.ProcessStatus]
        task <- (__ \ "task").read[Seq[com.gilt.svc.sundial.v0.models.Task]]
    ...
    implicit def jsonReadsSvcSundialProcessDefinition: play.api.libs.json.Reads[ProcessDefinition] = {
      for {
        ...
        schedule <- (__ \ "schedule").readNullable[com.gilt.svc.sundial.v0.models.ProcessSchedule]
        taskDefinitions <- (__ \ "task_definitions").read[Seq[com.gilt.svc.sundial.v0.models.TaskDefinition]]
        overlapAction <- (__ \ "overlap_action").read[com.gilt.svc.sundial.v0.models.ProcessOverlapAction]
        notifications <- (__ \ "notifications").readNullable[Seq[com.gilt.svc.sundial.v0.models.Notification]]
    ...
    implicit def jsonReadsSvcSundialShellScriptCommand: play.api.libs.json.Reads[ShellScriptCommand] = {
      for {
        ...
        environmentVariables <- (__ \ "environment_variables").readNullable[Seq[com.gilt.svc.sundial.v0.models.EnvironmentVariable]]
    ...
    implicit def jsonReadsSvcSundialTask: play.api.libs.json.Reads[Task] = {
      for {
        ...
        logEntries <- (__ \ "log_entries").read[Seq[com.gilt.svc.sundial.v0.models.LogEntry]]
        metadataEntries <- (__ \ "metadata_entries").read[Seq[com.gilt.svc.sundial.v0.models.MetadataEntry]]
        executionState <- (__ \ "execution_state").readNullable[Seq[com.gilt.svc.sundial.v0.models.MetadataEntry]]
        status <- (__ \ "status").read[com.gilt.svc.sundial.v0.models.TaskStatus]
    ...
    implicit def jsonReadsSvcSundialTaskDefinition: play.api.libs.json.Reads[TaskDefinition] = {
      for {
        taskDefinitionName <- (__ \ "task_definition_name").read[String]
        dependencies <- (__ \ "dependencies").read[Seq[com.gilt.svc.sundial.v0.models.TaskDependency]]
        executable <- (__ \ "executable").read[com.gilt.svc.sundial.v0.models.TaskExecutable]
  ...
  object Bindables {
    ...
    object Models {
      ...
      val emrReleaseLabelConverter: ApibuilderTypeConverter[com.gilt.svc.sundial.v0.models.EmrReleaseLabel] = new ApibuilderTypeConverter[com.gilt.svc.sundial.v0.models.EmrReleaseLabel] {
        ...
        override def example: com.gilt.svc.sundial.v0.models.EmrReleaseLabel = com.gilt.svc.sundial.v0.models.EmrReleaseLabel.Emr5140
