 ...
 * apidoc:0.11.4 http://www.apidoc.me/gilt/svc-sundial/0.0.4-dev/play_2_x_json
 */
  ...
  package object json {
    ...
    def jsObjectContinuousSchedule(obj: com.gilt.svc.sundial.v0.models.ContinuousSchedule) = {
      play.api.libs.json.Json.obj(
        "buffer_seconds" -> play.api.libs.json.Json.toJson(obj.bufferSeconds)
      )
    }
    ...
    def jsObjectDockerImageCommand(obj: com.gilt.svc.sundial.v0.models.DockerImageCommand) = {
      play.api.libs.json.Json.obj(
        ...
        "memory" -> play.api.libs.json.Json.toJson(obj.memory),
        "cpu" -> play.api.libs.json.Json.toJson(obj.cpu),
    ...
    def jsObjectProcessDefinition(obj: com.gilt.svc.sundial.v0.models.ProcessDefinition) = {
      play.api.libs.json.Json.obj(
        "process_definition_name" -> play.api.libs.json.JsString(obj.processDefinitionName),
        "paused" -> play.api.libs.json.Json.toJson(obj.paused),
        "process_description" -> play.api.libs.json.Json.toJson(obj.processDescription),
        "schedule" -> play.api.libs.json.Json.toJson(obj.schedule),
    ...
    def jsObjectTask(obj: com.gilt.svc.sundial.v0.models.Task) = {
      play.api.libs.json.Json.obj(
        ...
        "start_time" -> play.api.libs.json.JsString(_root_.org.joda.time.format.ISODateTimeFormat.dateTime.print(obj.startTime)),
        "end_time" -> play.api.libs.json.Json.toJson(obj.endTime),
        ...
        "execution_state" -> play.api.libs.json.Json.toJson(obj.executionState),
        "status" -> play.api.libs.json.JsString(obj.status.toString)
      )
    }
    ...
    def jsObjectTaskDefinition(obj: com.gilt.svc.sundial.v0.models.TaskDefinition) = {
      play.api.libs.json.Json.obj(
        ...
        "max_runtime_seconds" -> play.api.libs.json.Json.toJson(obj.maxRuntimeSeconds),
...
package com.gilt.svc.sundial.v0 {
  ...
  object Bindables {
    ...
    private[this] val enumProcessOverlapActionNotFound = (key: String, e: Exception) => s"Unrecognized $key, should be one of ${com.gilt.svc.sundial.v0.models.ProcessOverlapAction.all.mkString(", ")}"
    ...
    // Enum: ProcessStatus
    private[this] val enumProcessStatusNotFound = (key: String, e: Exception) => s"Unrecognized $key, should be one of ${com.gilt.svc.sundial.v0.models.ProcessStatus.all.mkString(", ")}"
    ...
    // Enum: TaskStatus
    private[this] val enumTaskStatusNotFound = (key: String, e: Exception) => s"Unrecognized $key, should be one of ${com.gilt.svc.sundial.v0.models.TaskStatus.all.mkString(", ")}"
