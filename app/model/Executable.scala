...
case class ContainerServiceExecutable(image: String, tag: String = "latest", command: Seq[String], memory: Option[Int], cpu: Option[Int], logPaths: Seq[String]) extends Executable
