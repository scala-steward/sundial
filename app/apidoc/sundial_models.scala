 ...
 * apibuilder:0.13.0 https://app.apibuilder.io/gilt/svc-sundial/0.2.3/play_2_x_json
 */
package com.gilt.svc.sundial.v0.models {
  ...
  object EmrReleaseLabel {
     ...
     * above.
     */
    val all: scala.List[EmrReleaseLabel] = scala.List(Emr5110, Emr5100, Emr590, Emr492, Emr491)
