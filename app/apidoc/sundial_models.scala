 ...
 * apibuilder 0.13.0 app.apibuilder.io/gilt/svc-sundial/0.2.4/play_2_x_json
 */
package com.gilt.svc.sundial.v0.models {
  ...
  object EmrReleaseLabel {
     ...
     * above.
     */
    val all: scala.List[EmrReleaseLabel] = scala.List(Emr5111, Emr5110, Emr5100, Emr590, Emr492, Emr491)
...
package com.gilt.svc.sundial.v0 {
  ...
  object Bindables {
    ...
    // Enum: DefaultEmrJobFlowRole
    private[this] val enumDefaultEmrJobFlowRoleNotFound = (key: String, e: _root_.java.lang.Exception) => s"Unrecognized $key, should be one of ${com.gilt.svc.sundial.v0.models.DefaultEmrJobFlowRole.all.mkString(", ")}"

    implicit val pathBindableEnumDefaultEmrJobFlowRole = new PathBindable.Parsing[com.gilt.svc.sundial.v0.models.DefaultEmrJobFlowRole] (
      DefaultEmrJobFlowRole.fromString(_).get, _.toString, enumDefaultEmrJobFlowRoleNotFound
    )

    implicit val queryStringBindableEnumDefaultEmrJobFlowRole = new QueryStringBindable.Parsing[com.gilt.svc.sundial.v0.models.DefaultEmrJobFlowRole](
      DefaultEmrJobFlowRole.fromString(_).get, _.toString, enumDefaultEmrJobFlowRoleNotFound
    )

    // Enum: DefaultEmrServiceRole
    private[this] val enumDefaultEmrServiceRoleNotFound = (key: String, e: _root_.java.lang.Exception) => s"Unrecognized $key, should be one of ${com.gilt.svc.sundial.v0.models.DefaultEmrServiceRole.all.mkString(", ")}"

    implicit val pathBindableEnumDefaultEmrServiceRole = new PathBindable.Parsing[com.gilt.svc.sundial.v0.models.DefaultEmrServiceRole] (
      DefaultEmrServiceRole.fromString(_).get, _.toString, enumDefaultEmrServiceRoleNotFound
    )

    implicit val queryStringBindableEnumDefaultEmrServiceRole = new QueryStringBindable.Parsing[com.gilt.svc.sundial.v0.models.DefaultEmrServiceRole](
      DefaultEmrServiceRole.fromString(_).get, _.toString, enumDefaultEmrServiceRoleNotFound
    )

    // Enum: EmrApplication
    private[this] val enumEmrApplicationNotFound = (key: String, e: _root_.java.lang.Exception) => s"Unrecognized $key, should be one of ${com.gilt.svc.sundial.v0.models.EmrApplication.all.mkString(", ")}"

    implicit val pathBindableEnumEmrApplication = new PathBindable.Parsing[com.gilt.svc.sundial.v0.models.EmrApplication] (
      EmrApplication.fromString(_).get, _.toString, enumEmrApplicationNotFound
    )

    implicit val queryStringBindableEnumEmrApplication = new QueryStringBindable.Parsing[com.gilt.svc.sundial.v0.models.EmrApplication](
      EmrApplication.fromString(_).get, _.toString, enumEmrApplicationNotFound
    )

    // Enum: EmrReleaseLabel
    private[this] val enumEmrReleaseLabelNotFound = (key: String, e: _root_.java.lang.Exception) => s"Unrecognized $key, should be one of ${com.gilt.svc.sundial.v0.models.EmrReleaseLabel.all.mkString(", ")}"

    implicit val pathBindableEnumEmrReleaseLabel = new PathBindable.Parsing[com.gilt.svc.sundial.v0.models.EmrReleaseLabel] (
      EmrReleaseLabel.fromString(_).get, _.toString, enumEmrReleaseLabelNotFound
    )

    implicit val queryStringBindableEnumEmrReleaseLabel = new QueryStringBindable.Parsing[com.gilt.svc.sundial.v0.models.EmrReleaseLabel](
      EmrReleaseLabel.fromString(_).get, _.toString, enumEmrReleaseLabelNotFound
    )
    ...
    // Enum: OnDemand
    private[this] val enumOnDemandNotFound = (key: String, e: _root_.java.lang.Exception) => s"Unrecognized $key, should be one of ${com.gilt.svc.sundial.v0.models.OnDemand.all.mkString(", ")}"

    implicit val pathBindableEnumOnDemand = new PathBindable.Parsing[com.gilt.svc.sundial.v0.models.OnDemand] (
      OnDemand.fromString(_).get, _.toString, enumOnDemandNotFound
    )

    implicit val queryStringBindableEnumOnDemand = new QueryStringBindable.Parsing[com.gilt.svc.sundial.v0.models.OnDemand](
      OnDemand.fromString(_).get, _.toString, enumOnDemandNotFound
    )
