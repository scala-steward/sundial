 ...
 * Service version: 0.0.10-dev
 * apidoc:0.11.52 http://www.apidoc.me/gilt/svc-sundial/0.0.10-dev/play_2_x_json
 */
...
package com.gilt.svc.sundial.v0.models {
  ...
  package object json {
    ...
    def jsObjectEmail(obj: com.gilt.svc.sundial.v0.models.Email) = {
      play.api.libs.json.Json.obj(
    ...
    def jsObjectNotification(obj: com.gilt.svc.sundial.v0.models.Notification) = {
      obj match {
