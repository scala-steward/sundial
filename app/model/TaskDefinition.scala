...
case class TaskDefinition(name: String, processId: UUID, executable: Executable,
                          limits: TaskLimits, backoff: TaskBackoff,
                          dependencies: TaskDependencies,
                          requireExplicitSuccess: Boolean)

case class TaskDefinitionTemplate(name: String, processDefinitionName: String, executable: Executable,
                          limits: TaskLimits, backoff: TaskBackoff,
                          dependencies: TaskDependencies,
                          requireExplicitSuccess: Boolean)