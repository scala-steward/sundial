...
trait TriggerDao {
  def loadOpenProcessTriggerRequests(
      processDefinitionName: Option[String] = None): Seq[ProcessTriggerRequest]
  def loadOpenTaskTriggerRequests(
      processDefinitionName: Option[String] = None): Seq[TaskTriggerRequest]
  def saveProcessTriggerRequest(
      request: ProcessTriggerRequest): ProcessTriggerRequest
