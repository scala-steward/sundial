...
package com.hbc.svc.sundial.v1.models {
  ...
  final case class BatchImageCommand(
    ...
    environmentVariables: Seq[com.hbc.svc.sundial.v1.models.EnvironmentVariable] = Nil,
  ...
  final case class Email(
    name: String,
    email: String,
    notifyWhen: com.hbc.svc.sundial.v1.models.NotificationOptions = com.hbc.svc.sundial.v1.models.NotificationOptions.OnStateChangeAndFailures
  ...
  final case class EmrCommand(
    ...
    args: Seq[String],
    s3LogDetails: _root_.scala.Option[com.hbc.svc.sundial.v1.models.S3LogDetails] = None,
    loadData: _root_.scala.Option[Seq[com.hbc.svc.sundial.v1.models.S3Cp]] = None,
    saveResults: _root_.scala.Option[Seq[com.hbc.svc.sundial.v1.models.S3Cp]] = None
  ) extends TaskExecutable
  ...
  final case class EmrConfiguration(
    ...
    configurations: _root_.scala.Option[Seq[com.hbc.svc.sundial.v1.models.EmrConfiguration]] = None,
  ...
  final case class NewEmrCluster(
    name: String,
    releaseLabel: com.hbc.svc.sundial.v1.models.EmrReleaseLabel = com.hbc.svc.sundial.v1.models.EmrReleaseLabel.Emr5100,
    ...
    coreInstance: _root_.scala.Option[com.hbc.svc.sundial.v1.models.EmrInstanceGroupDetails] = None,
    taskInstance: _root_.scala.Option[com.hbc.svc.sundial.v1.models.EmrInstanceGroupDetails] = None,
  ...
  final case class ProcessDefinition(
    ...
    schedule: _root_.scala.Option[com.hbc.svc.sundial.v1.models.ProcessSchedule] = None,
    taskDefinitions: Seq[com.hbc.svc.sundial.v1.models.TaskDefinition],
    overlapAction: com.hbc.svc.sundial.v1.models.ProcessOverlapAction = com.hbc.svc.sundial.v1.models.ProcessOverlapAction.Wait,
    notifications: _root_.scala.Option[Seq[com.hbc.svc.sundial.v1.models.Notification]] = None
  )
  ...
  final case class ShellScriptCommand(
    script: String,
    environmentVariables: _root_.scala.Option[Seq[com.hbc.svc.sundial.v1.models.EnvironmentVariable]] = None
  ) extends TaskExecutable
  ...
  final case class Task(
    ...
    executionState: _root_.scala.Option[Seq[com.hbc.svc.sundial.v1.models.MetadataEntry]] = None,
  ...
  object EmrReleaseLabel {
     ...
     * above.
     */
    val all: scala.List[EmrReleaseLabel] = scala.List(Emr5160, Emr5150, Emr5140, Emr5130, Emr5121, Emr5120, Emr5111, Emr5110, Emr5100, Emr590, Emr492, Emr491)
...
package com.hbc.svc.sundial.v1.models {
  ...
  package object json {
    ...
    private[v1] implicit val jsonReadsJodaLocalDate = __.read[String].map { str =>
      import org.joda.time.format.ISODateTimeFormat.dateParser
      dateParser.parseLocalDate(str)
    }

    private[v1] implicit val jsonWritesJodaLocalDate = new Writes[org.joda.time.LocalDate] {
    ...
    implicit val jsonReadsSvcSundialDefaultEmrJobFlowRole = new play.api.libs.json.Reads[com.hbc.svc.sundial.v1.models.DefaultEmrJobFlowRole] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[com.hbc.svc.sundial.v1.models.DefaultEmrJobFlowRole] = {
        js match {
          case v: play.api.libs.json.JsString => play.api.libs.json.JsSuccess(com.hbc.svc.sundial.v1.models.DefaultEmrJobFlowRole(v.value))
          case _ => {
            (js \ "value").validate[String] match {
              case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(com.hbc.svc.sundial.v1.models.DefaultEmrJobFlowRole(v))
    ...
    def jsonWritesSvcSundialDefaultEmrJobFlowRole(obj: com.hbc.svc.sundial.v1.models.DefaultEmrJobFlowRole) = {
      play.api.libs.json.JsString(obj.toString)
    }

    def jsObjectDefaultEmrJobFlowRole(obj: com.hbc.svc.sundial.v1.models.DefaultEmrJobFlowRole) = {
      play.api.libs.json.Json.obj("value" -> play.api.libs.json.JsString(obj.toString))
    }

    implicit def jsonWritesSvcSundialDefaultEmrJobFlowRole: play.api.libs.json.Writes[DefaultEmrJobFlowRole] = {
      new play.api.libs.json.Writes[com.hbc.svc.sundial.v1.models.DefaultEmrJobFlowRole] {
    ...
    implicit val jsonReadsSvcSundialDefaultEmrServiceRole = new play.api.libs.json.Reads[com.hbc.svc.sundial.v1.models.DefaultEmrServiceRole] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[com.hbc.svc.sundial.v1.models.DefaultEmrServiceRole] = {
        js match {
          case v: play.api.libs.json.JsString => play.api.libs.json.JsSuccess(com.hbc.svc.sundial.v1.models.DefaultEmrServiceRole(v.value))
          case _ => {
            (js \ "value").validate[String] match {
              case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(com.hbc.svc.sundial.v1.models.DefaultEmrServiceRole(v))
              case err: play.api.libs.json.JsError => err
            }
          }
        }
    ...
    def jsonWritesSvcSundialDefaultEmrServiceRole(obj: com.hbc.svc.sundial.v1.models.DefaultEmrServiceRole) = {
      play.api.libs.json.JsString(obj.toString)
    }

    def jsObjectDefaultEmrServiceRole(obj: com.hbc.svc.sundial.v1.models.DefaultEmrServiceRole) = {
      play.api.libs.json.Json.obj("value" -> play.api.libs.json.JsString(obj.toString))
    }

    implicit def jsonWritesSvcSundialDefaultEmrServiceRole: play.api.libs.json.Writes[DefaultEmrServiceRole] = {
      new play.api.libs.json.Writes[com.hbc.svc.sundial.v1.models.DefaultEmrServiceRole] {
    ...
    implicit val jsonReadsSvcSundialEmrApplication = new play.api.libs.json.Reads[com.hbc.svc.sundial.v1.models.EmrApplication] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[com.hbc.svc.sundial.v1.models.EmrApplication] = {
        js match {
          case v: play.api.libs.json.JsString => play.api.libs.json.JsSuccess(com.hbc.svc.sundial.v1.models.EmrApplication(v.value))
          case _ => {
            (js \ "value").validate[String] match {
              case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(com.hbc.svc.sundial.v1.models.EmrApplication(v))
              case err: play.api.libs.json.JsError => err
            }
          }
        }
    ...
    def jsonWritesSvcSundialEmrApplication(obj: com.hbc.svc.sundial.v1.models.EmrApplication) = {
      play.api.libs.json.JsString(obj.toString)
    }

    def jsObjectEmrApplication(obj: com.hbc.svc.sundial.v1.models.EmrApplication) = {
      play.api.libs.json.Json.obj("value" -> play.api.libs.json.JsString(obj.toString))
    }

    implicit def jsonWritesSvcSundialEmrApplication: play.api.libs.json.Writes[EmrApplication] = {
      new play.api.libs.json.Writes[com.hbc.svc.sundial.v1.models.EmrApplication] {
    ...
    implicit val jsonReadsSvcSundialEmrReleaseLabel = new play.api.libs.json.Reads[com.hbc.svc.sundial.v1.models.EmrReleaseLabel] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[com.hbc.svc.sundial.v1.models.EmrReleaseLabel] = {
        js match {
          case v: play.api.libs.json.JsString => play.api.libs.json.JsSuccess(com.hbc.svc.sundial.v1.models.EmrReleaseLabel(v.value))
          case _ => {
            (js \ "value").validate[String] match {
              case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(com.hbc.svc.sundial.v1.models.EmrReleaseLabel(v))
              case err: play.api.libs.json.JsError => err
            }
          }
        }
    ...
    def jsonWritesSvcSundialEmrReleaseLabel(obj: com.hbc.svc.sundial.v1.models.EmrReleaseLabel) = {
      play.api.libs.json.JsString(obj.toString)
    }

    def jsObjectEmrReleaseLabel(obj: com.hbc.svc.sundial.v1.models.EmrReleaseLabel) = {
      play.api.libs.json.Json.obj("value" -> play.api.libs.json.JsString(obj.toString))
    }

    implicit def jsonWritesSvcSundialEmrReleaseLabel: play.api.libs.json.Writes[EmrReleaseLabel] = {
      new play.api.libs.json.Writes[com.hbc.svc.sundial.v1.models.EmrReleaseLabel] {
    ...
    implicit val jsonReadsSvcSundialNotificationOptions = new play.api.libs.json.Reads[com.hbc.svc.sundial.v1.models.NotificationOptions] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[com.hbc.svc.sundial.v1.models.NotificationOptions] = {
        js match {
          case v: play.api.libs.json.JsString => play.api.libs.json.JsSuccess(com.hbc.svc.sundial.v1.models.NotificationOptions(v.value))
          case _ => {
            (js \ "value").validate[String] match {
              case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(com.hbc.svc.sundial.v1.models.NotificationOptions(v))
              case err: play.api.libs.json.JsError => err
            }
          }
        }
    ...
    def jsonWritesSvcSundialNotificationOptions(obj: com.hbc.svc.sundial.v1.models.NotificationOptions) = {
      play.api.libs.json.JsString(obj.toString)
    }

    def jsObjectNotificationOptions(obj: com.hbc.svc.sundial.v1.models.NotificationOptions) = {
      play.api.libs.json.Json.obj("value" -> play.api.libs.json.JsString(obj.toString))
    }

    implicit def jsonWritesSvcSundialNotificationOptions: play.api.libs.json.Writes[NotificationOptions] = {
      new play.api.libs.json.Writes[com.hbc.svc.sundial.v1.models.NotificationOptions] {
    ...
    implicit val jsonReadsSvcSundialOnDemand = new play.api.libs.json.Reads[com.hbc.svc.sundial.v1.models.OnDemand] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[com.hbc.svc.sundial.v1.models.OnDemand] = {
        js match {
          case v: play.api.libs.json.JsString => play.api.libs.json.JsSuccess(com.hbc.svc.sundial.v1.models.OnDemand(v.value))
          case _ => {
            (js \ "value").validate[String] match {
              case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(com.hbc.svc.sundial.v1.models.OnDemand(v))
              case err: play.api.libs.json.JsError => err
            }
          }
        }
    ...
    def jsonWritesSvcSundialOnDemand(obj: com.hbc.svc.sundial.v1.models.OnDemand) = {
      play.api.libs.json.JsString(obj.toString)
    }
    ...
    implicit val jsonReadsSvcSundialProcessOverlapAction = new play.api.libs.json.Reads[com.hbc.svc.sundial.v1.models.ProcessOverlapAction] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[com.hbc.svc.sundial.v1.models.ProcessOverlapAction] = {
        js match {
          case v: play.api.libs.json.JsString => play.api.libs.json.JsSuccess(com.hbc.svc.sundial.v1.models.ProcessOverlapAction(v.value))
          case _ => {
            (js \ "value").validate[String] match {
              case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(com.hbc.svc.sundial.v1.models.ProcessOverlapAction(v))
              case err: play.api.libs.json.JsError => err
            }
          }
        }
    ...
    def jsonWritesSvcSundialProcessOverlapAction(obj: com.hbc.svc.sundial.v1.models.ProcessOverlapAction) = {
      play.api.libs.json.JsString(obj.toString)
    }

    def jsObjectProcessOverlapAction(obj: com.hbc.svc.sundial.v1.models.ProcessOverlapAction) = {
      play.api.libs.json.Json.obj("value" -> play.api.libs.json.JsString(obj.toString))
    }

    implicit def jsonWritesSvcSundialProcessOverlapAction: play.api.libs.json.Writes[ProcessOverlapAction] = {
      new play.api.libs.json.Writes[com.hbc.svc.sundial.v1.models.ProcessOverlapAction] {
    ...
    implicit val jsonReadsSvcSundialProcessStatus = new play.api.libs.json.Reads[com.hbc.svc.sundial.v1.models.ProcessStatus] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[com.hbc.svc.sundial.v1.models.ProcessStatus] = {
        js match {
          case v: play.api.libs.json.JsString => play.api.libs.json.JsSuccess(com.hbc.svc.sundial.v1.models.ProcessStatus(v.value))
          case _ => {
            (js \ "value").validate[String] match {
              case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(com.hbc.svc.sundial.v1.models.ProcessStatus(v))
              case err: play.api.libs.json.JsError => err
            }
          }
        }
    ...
    def jsonWritesSvcSundialProcessStatus(obj: com.hbc.svc.sundial.v1.models.ProcessStatus) = {
      play.api.libs.json.JsString(obj.toString)
    }

    def jsObjectProcessStatus(obj: com.hbc.svc.sundial.v1.models.ProcessStatus) = {
      play.api.libs.json.Json.obj("value" -> play.api.libs.json.JsString(obj.toString))
    }
    ...
    implicit val jsonReadsSvcSundialTaskStatus = new play.api.libs.json.Reads[com.hbc.svc.sundial.v1.models.TaskStatus] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[com.hbc.svc.sundial.v1.models.TaskStatus] = {
        js match {
          case v: play.api.libs.json.JsString => play.api.libs.json.JsSuccess(com.hbc.svc.sundial.v1.models.TaskStatus(v.value))
          case _ => {
            (js \ "value").validate[String] match {
              case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(com.hbc.svc.sundial.v1.models.TaskStatus(v))
              case err: play.api.libs.json.JsError => err
            }
          }
        }
    ...
    def jsonWritesSvcSundialTaskStatus(obj: com.hbc.svc.sundial.v1.models.TaskStatus) = {
      play.api.libs.json.JsString(obj.toString)
    }
    ...
    implicit def jsonReadsSvcSundialBatchImageCommand: play.api.libs.json.Reads[BatchImageCommand] = {
      for {
        ...
        environmentVariables <- (__ \ "environment_variables").read[Seq[com.hbc.svc.sundial.v1.models.EnvironmentVariable]]
    ...
    def jsObjectBatchImageCommand(obj: com.hbc.svc.sundial.v1.models.BatchImageCommand): play.api.libs.json.JsObject = {
    ...
    def jsObjectContinuousSchedule(obj: com.hbc.svc.sundial.v1.models.ContinuousSchedule): play.api.libs.json.JsObject = {
    ...
    def jsObjectCronSchedule(obj: com.hbc.svc.sundial.v1.models.CronSchedule): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
    ...
    def jsObjectCustomEmrJobFlowRole(obj: com.hbc.svc.sundial.v1.models.CustomEmrJobFlowRole): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
    ...
    def jsObjectCustomEmrServiceRole(obj: com.hbc.svc.sundial.v1.models.CustomEmrServiceRole): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "role_name" -> play.api.libs.json.JsString(obj.roleName)
      )
    }
    ...
    implicit def jsonReadsSvcSundialDockerImageCommand: play.api.libs.json.Reads[DockerImageCommand] = {
      for {
        ...
        environmentVariables <- (__ \ "environment_variables").read[Seq[com.hbc.svc.sundial.v1.models.EnvironmentVariable]]
      } yield DockerImageCommand(image, tag, command, memory, cpu, taskRoleArn, logPaths, environmentVariables)
    }

    def jsObjectDockerImageCommand(obj: com.hbc.svc.sundial.v1.models.DockerImageCommand): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "image" -> play.api.libs.json.JsString(obj.image),
        "tag" -> play.api.libs.json.JsString(obj.tag),
        "command" -> play.api.libs.json.Json.toJson(obj.command),
    ...
    implicit def jsonReadsSvcSundialEmail: play.api.libs.json.Reads[Email] = {
      for {
        ...
        notifyWhen <- (__ \ "notify_when").read[com.hbc.svc.sundial.v1.models.NotificationOptions]
      } yield Email(name, email, notifyWhen)
    }

    def jsObjectEmail(obj: com.hbc.svc.sundial.v1.models.Email): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
    ...
    implicit def jsonReadsSvcSundialEmrCommand: play.api.libs.json.Reads[EmrCommand] = {
      for {
        emrCluster <- (__ \ "emr_cluster").read[com.hbc.svc.sundial.v1.models.EmrCluster]
        ...
        s3LogDetails <- (__ \ "s3_log_details").readNullable[com.hbc.svc.sundial.v1.models.S3LogDetails]
        loadData <- (__ \ "load_data").readNullable[Seq[com.hbc.svc.sundial.v1.models.S3Cp]]
        saveResults <- (__ \ "save_results").readNullable[Seq[com.hbc.svc.sundial.v1.models.S3Cp]]
      } yield EmrCommand(emrCluster, jobName, region, `class`, s3JarPath, sparkConf, args, s3LogDetails, loadData, saveResults)
    }

    def jsObjectEmrCommand(obj: com.hbc.svc.sundial.v1.models.EmrCommand): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
    ...
    implicit def jsonReadsSvcSundialEmrConfiguration: play.api.libs.json.Reads[EmrConfiguration] = {
      for {
        ...
        configurations <- (__ \ "configurations").lazyReadNullable(play.api.libs.json.Reads.of[Seq[com.hbc.svc.sundial.v1.models.EmrConfiguration]])
        properties <- (__ \ "properties").readNullable[Map[String, String]]
      } yield EmrConfiguration(classification, configurations, properties)
    }

    def jsObjectEmrConfiguration(obj: com.hbc.svc.sundial.v1.models.EmrConfiguration): play.api.libs.json.JsObject = {
    ...
    implicit def jsonWritesSvcSundialEmrConfiguration: play.api.libs.json.Writes[EmrConfiguration] = {
      new play.api.libs.json.Writes[com.hbc.svc.sundial.v1.models.EmrConfiguration] {
    ...
    implicit def jsonReadsSvcSundialEmrInstanceGroupDetails: play.api.libs.json.Reads[EmrInstanceGroupDetails] = {
      for {
        ...
        awsMarket <- (__ \ "aws_market").read[com.hbc.svc.sundial.v1.models.AwsMarket]
    ...
    def jsObjectEmrInstanceGroupDetails(obj: com.hbc.svc.sundial.v1.models.EmrInstanceGroupDetails): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
    ...
    implicit def jsonWritesSvcSundialEmrInstanceGroupDetails: play.api.libs.json.Writes[EmrInstanceGroupDetails] = {
      new play.api.libs.json.Writes[com.hbc.svc.sundial.v1.models.EmrInstanceGroupDetails] {
        def writes(obj: com.hbc.svc.sundial.v1.models.EmrInstanceGroupDetails) = {
    ...
    def jsObjectEnvironmentVariable(obj: com.hbc.svc.sundial.v1.models.EnvironmentVariable): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
    ...
    implicit def jsonWritesSvcSundialEnvironmentVariable: play.api.libs.json.Writes[EnvironmentVariable] = {
      new play.api.libs.json.Writes[com.hbc.svc.sundial.v1.models.EnvironmentVariable] {
    ...
    def jsObjectExistingEmrCluster(obj: com.hbc.svc.sundial.v1.models.ExistingEmrCluster): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
    ...
    def jsObjectHealthcheck(obj: com.hbc.svc.sundial.v1.models.Healthcheck): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
    ...
    def jsObjectLogEntry(obj: com.hbc.svc.sundial.v1.models.LogEntry): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
    ...
    def jsObjectMetadataEntry(obj: com.hbc.svc.sundial.v1.models.MetadataEntry): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
    ...
    implicit def jsonReadsSvcSundialNewEmrCluster: play.api.libs.json.Reads[NewEmrCluster] = {
      for {
        name <- (__ \ "name").read[String]
        releaseLabel <- (__ \ "release_label").read[com.hbc.svc.sundial.v1.models.EmrReleaseLabel]
        applications <- (__ \ "applications").read[Seq[com.hbc.svc.sundial.v1.models.EmrApplication]]
        s3LogUri <- (__ \ "s3_log_uri").read[String]
        masterInstance <- (__ \ "master_instance").read[com.hbc.svc.sundial.v1.models.EmrInstanceGroupDetails]
        coreInstance <- (__ \ "core_instance").readNullable[com.hbc.svc.sundial.v1.models.EmrInstanceGroupDetails]
        taskInstance <- (__ \ "task_instance").readNullable[com.hbc.svc.sundial.v1.models.EmrInstanceGroupDetails]
        ec2Subnet <- (__ \ "ec2_subnet").readNullable[String]
        emrServiceRole <- (__ \ "emr_service_role").read[com.hbc.svc.sundial.v1.models.EmrServiceRole]
        emrJobFlowRole <- (__ \ "emr_job_flow_role").read[com.hbc.svc.sundial.v1.models.EmrJobFlowRole]
        visibleToAllUsers <- (__ \ "visible_to_all_users").read[Boolean]
        configurations <- (__ \ "configurations").readNullable[Seq[com.hbc.svc.sundial.v1.models.EmrConfiguration]]
    ...
    def jsObjectNewEmrCluster(obj: com.hbc.svc.sundial.v1.models.NewEmrCluster): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "name" -> play.api.libs.json.JsString(obj.name),
    ...
    def jsObjectPagerduty(obj: com.hbc.svc.sundial.v1.models.Pagerduty): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
    ...
    implicit def jsonReadsSvcSundialProcess: play.api.libs.json.Reads[Process] = {
      for {
        ...
        status <- (__ \ "status").read[com.hbc.svc.sundial.v1.models.ProcessStatus]
    ...
    def jsObjectProcess(obj: com.hbc.svc.sundial.v1.models.Process): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
    ...
    implicit def jsonReadsSvcSundialProcessDefinition: play.api.libs.json.Reads[ProcessDefinition] = {
      for {
        ...
        schedule <- (__ \ "schedule").readNullable[com.hbc.svc.sundial.v1.models.ProcessSchedule]
        taskDefinitions <- (__ \ "task_definitions").read[Seq[com.hbc.svc.sundial.v1.models.TaskDefinition]]
        overlapAction <- (__ \ "overlap_action").read[com.hbc.svc.sundial.v1.models.ProcessOverlapAction]
        notifications <- (__ \ "notifications").readNullable[Seq[com.hbc.svc.sundial.v1.models.Notification]]
    ...
    def jsObjectProcessDefinition(obj: com.hbc.svc.sundial.v1.models.ProcessDefinition): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "process_definition_name" -> play.api.libs.json.JsString(obj.processDefinitionName),
    ...
    implicit def jsonWritesSvcSundialProcessDefinition: play.api.libs.json.Writes[ProcessDefinition] = {
      new play.api.libs.json.Writes[com.hbc.svc.sundial.v1.models.ProcessDefinition] {
    ...
    def jsObjectS3Cp(obj: com.hbc.svc.sundial.v1.models.S3Cp): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "source" -> play.api.libs.json.JsString(obj.source),
    ...
    def jsObjectS3LogDetails(obj: com.hbc.svc.sundial.v1.models.S3LogDetails): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
    ...
    implicit def jsonReadsSvcSundialShellScriptCommand: play.api.libs.json.Reads[ShellScriptCommand] = {
      for {
        ...
        environmentVariables <- (__ \ "environment_variables").readNullable[Seq[com.hbc.svc.sundial.v1.models.EnvironmentVariable]]
      } yield ShellScriptCommand(script, environmentVariables)
    }

    def jsObjectShellScriptCommand(obj: com.hbc.svc.sundial.v1.models.ShellScriptCommand): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
    ...
    def jsObjectSpot(obj: com.hbc.svc.sundial.v1.models.Spot): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
    ...
    implicit def jsonReadsSvcSundialTask: play.api.libs.json.Reads[Task] = {
      for {
        ...
        logEntries <- (__ \ "log_entries").read[Seq[com.hbc.svc.sundial.v1.models.LogEntry]]
        metadataEntries <- (__ \ "metadata_entries").read[Seq[com.hbc.svc.sundial.v1.models.MetadataEntry]]
        executionState <- (__ \ "execution_state").readNullable[Seq[com.hbc.svc.sundial.v1.models.MetadataEntry]]
    ...
    def jsObjectTask(obj: com.hbc.svc.sundial.v1.models.Task): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
    ...
    implicit def jsonReadsSvcSundialTaskDefinition: play.api.libs.json.Reads[TaskDefinition] = {
      for {
        taskDefinitionName <- (__ \ "task_definition_name").read[String]
        dependencies <- (__ \ "dependencies").read[Seq[com.hbc.svc.sundial.v1.models.TaskDependency]]
        executable <- (__ \ "executable").read[com.hbc.svc.sundial.v1.models.TaskExecutable]
    ...
    def jsObjectTaskDefinition(obj: com.hbc.svc.sundial.v1.models.TaskDefinition): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "task_definition_name" -> play.api.libs.json.JsString(obj.taskDefinitionName),
    ...
    implicit def jsonWritesSvcSundialTaskDefinition: play.api.libs.json.Writes[TaskDefinition] = {
      new play.api.libs.json.Writes[com.hbc.svc.sundial.v1.models.TaskDefinition] {
    ...
    def jsObjectTaskDependency(obj: com.hbc.svc.sundial.v1.models.TaskDependency): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "task_definition_name" -> play.api.libs.json.JsString(obj.taskDefinitionName),
    ...
    implicit def jsonWritesSvcSundialTaskDependency: play.api.libs.json.Writes[TaskDependency] = {
      new play.api.libs.json.Writes[com.hbc.svc.sundial.v1.models.TaskDependency] {
    ...
    implicit def jsonReadsSvcSundialAwsMarket: play.api.libs.json.Reads[AwsMarket] = {
      (
        ...
        orElse
        play.api.libs.json.Reads(jsValue => play.api.libs.json.JsSuccess(com.hbc.svc.sundial.v1.models.AwsMarketUndefinedType(jsValue.toString))).asInstanceOf[play.api.libs.json.Reads[AwsMarket]]
      )
    }

    def jsObjectAwsMarket(obj: com.hbc.svc.sundial.v1.models.AwsMarket): play.api.libs.json.JsObject = {
      obj match {
        case x: com.hbc.svc.sundial.v1.models.OnDemand => play.api.libs.json.Json.obj("on_demand" -> play.api.libs.json.JsString(x.toString))
        case x: com.hbc.svc.sundial.v1.models.Spot => play.api.libs.json.Json.obj("spot" -> jsObjectSpot(x))
        case x: com.hbc.svc.sundial.v1.models.AwsMarketUndefinedType => sys.error(s"The type[com.hbc.svc.sundial.v1.models.AwsMarketUndefinedType] should never be serialized")
      }
    }
    ...
    implicit def jsonReadsSvcSundialEmrCluster: play.api.libs.json.Reads[EmrCluster] = {
      (
        ...
        orElse
        play.api.libs.json.Reads(jsValue => play.api.libs.json.JsSuccess(com.hbc.svc.sundial.v1.models.EmrClusterUndefinedType(jsValue.toString))).asInstanceOf[play.api.libs.json.Reads[EmrCluster]]
      )
    }

    def jsObjectEmrCluster(obj: com.hbc.svc.sundial.v1.models.EmrCluster): play.api.libs.json.JsObject = {
      obj match {
        case x: com.hbc.svc.sundial.v1.models.NewEmrCluster => play.api.libs.json.Json.obj("new_emr_cluster" -> jsObjectNewEmrCluster(x))
        case x: com.hbc.svc.sundial.v1.models.ExistingEmrCluster => play.api.libs.json.Json.obj("existing_emr_cluster" -> jsObjectExistingEmrCluster(x))
        case x: com.hbc.svc.sundial.v1.models.EmrClusterUndefinedType => sys.error(s"The type[com.hbc.svc.sundial.v1.models.EmrClusterUndefinedType] should never be serialized")
      }
    }
    ...
    implicit def jsonReadsSvcSundialEmrJobFlowRole: play.api.libs.json.Reads[EmrJobFlowRole] = {
      (
        ...
        orElse
        play.api.libs.json.Reads(jsValue => play.api.libs.json.JsSuccess(com.hbc.svc.sundial.v1.models.EmrJobFlowRoleUndefinedType(jsValue.toString))).asInstanceOf[play.api.libs.json.Reads[EmrJobFlowRole]]
      )
    }

    def jsObjectEmrJobFlowRole(obj: com.hbc.svc.sundial.v1.models.EmrJobFlowRole): play.api.libs.json.JsObject = {
      obj match {
        case x: com.hbc.svc.sundial.v1.models.DefaultEmrJobFlowRole => play.api.libs.json.Json.obj("default_emr_job_flow_role" -> play.api.libs.json.JsString(x.toString))
        case x: com.hbc.svc.sundial.v1.models.CustomEmrJobFlowRole => play.api.libs.json.Json.obj("custom_emr_job_flow_role" -> jsObjectCustomEmrJobFlowRole(x))
        case x: com.hbc.svc.sundial.v1.models.EmrJobFlowRoleUndefinedType => sys.error(s"The type[com.hbc.svc.sundial.v1.models.EmrJobFlowRoleUndefinedType] should never be serialized")
      }
    }

    implicit def jsonWritesSvcSundialEmrJobFlowRole: play.api.libs.json.Writes[EmrJobFlowRole] = {
      new play.api.libs.json.Writes[com.hbc.svc.sundial.v1.models.EmrJobFlowRole] {
    ...
    implicit def jsonReadsSvcSundialEmrServiceRole: play.api.libs.json.Reads[EmrServiceRole] = {
      (
        ...
        orElse
        play.api.libs.json.Reads(jsValue => play.api.libs.json.JsSuccess(com.hbc.svc.sundial.v1.models.EmrServiceRoleUndefinedType(jsValue.toString))).asInstanceOf[play.api.libs.json.Reads[EmrServiceRole]]
      )
    }

    def jsObjectEmrServiceRole(obj: com.hbc.svc.sundial.v1.models.EmrServiceRole): play.api.libs.json.JsObject = {
      obj match {
        case x: com.hbc.svc.sundial.v1.models.DefaultEmrServiceRole => play.api.libs.json.Json.obj("default_emr_service_role" -> play.api.libs.json.JsString(x.toString))
        case x: com.hbc.svc.sundial.v1.models.CustomEmrServiceRole => play.api.libs.json.Json.obj("custom_emr_service_role" -> jsObjectCustomEmrServiceRole(x))
        case x: com.hbc.svc.sundial.v1.models.EmrServiceRoleUndefinedType => sys.error(s"The type[com.hbc.svc.sundial.v1.models.EmrServiceRoleUndefinedType] should never be serialized")
      }
    }

    implicit def jsonWritesSvcSundialEmrServiceRole: play.api.libs.json.Writes[EmrServiceRole] = {
      new play.api.libs.json.Writes[com.hbc.svc.sundial.v1.models.EmrServiceRole] {
    ...
    implicit def jsonReadsSvcSundialNotification: play.api.libs.json.Reads[Notification] = {
      (
        ...
        orElse
        play.api.libs.json.Reads(jsValue => play.api.libs.json.JsSuccess(com.hbc.svc.sundial.v1.models.NotificationUndefinedType(jsValue.toString))).asInstanceOf[play.api.libs.json.Reads[Notification]]
      )
    }

    def jsObjectNotification(obj: com.hbc.svc.sundial.v1.models.Notification): play.api.libs.json.JsObject = {
      obj match {
        case x: com.hbc.svc.sundial.v1.models.Email => play.api.libs.json.Json.obj("email" -> jsObjectEmail(x))
        case x: com.hbc.svc.sundial.v1.models.Pagerduty => play.api.libs.json.Json.obj("pagerduty" -> jsObjectPagerduty(x))
        case x: com.hbc.svc.sundial.v1.models.NotificationUndefinedType => sys.error(s"The type[com.hbc.svc.sundial.v1.models.NotificationUndefinedType] should never be serialized")
      }
    }
    ...
    implicit def jsonReadsSvcSundialProcessSchedule: play.api.libs.json.Reads[ProcessSchedule] = {
      (
        ...
        orElse
        play.api.libs.json.Reads(jsValue => play.api.libs.json.JsSuccess(com.hbc.svc.sundial.v1.models.ProcessScheduleUndefinedType(jsValue.toString))).asInstanceOf[play.api.libs.json.Reads[ProcessSchedule]]
      )
    }

    def jsObjectProcessSchedule(obj: com.hbc.svc.sundial.v1.models.ProcessSchedule): play.api.libs.json.JsObject = {
      obj match {
        case x: com.hbc.svc.sundial.v1.models.CronSchedule => play.api.libs.json.Json.obj("cron_schedule" -> jsObjectCronSchedule(x))
        case x: com.hbc.svc.sundial.v1.models.ContinuousSchedule => play.api.libs.json.Json.obj("continuous_schedule" -> jsObjectContinuousSchedule(x))
        case x: com.hbc.svc.sundial.v1.models.ProcessScheduleUndefinedType => sys.error(s"The type[com.hbc.svc.sundial.v1.models.ProcessScheduleUndefinedType] should never be serialized")
      }
    }

    implicit def jsonWritesSvcSundialProcessSchedule: play.api.libs.json.Writes[ProcessSchedule] = {
      new play.api.libs.json.Writes[com.hbc.svc.sundial.v1.models.ProcessSchedule] {
    ...
    implicit def jsonReadsSvcSundialTaskExecutable: play.api.libs.json.Reads[TaskExecutable] = {
      (
        ...
        orElse
        play.api.libs.json.Reads(jsValue => play.api.libs.json.JsSuccess(com.hbc.svc.sundial.v1.models.TaskExecutableUndefinedType(jsValue.toString))).asInstanceOf[play.api.libs.json.Reads[TaskExecutable]]
      )
    }

    def jsObjectTaskExecutable(obj: com.hbc.svc.sundial.v1.models.TaskExecutable): play.api.libs.json.JsObject = {
      obj match {
        case x: com.hbc.svc.sundial.v1.models.DockerImageCommand => play.api.libs.json.Json.obj("docker_image_command" -> jsObjectDockerImageCommand(x))
        case x: com.hbc.svc.sundial.v1.models.ShellScriptCommand => play.api.libs.json.Json.obj("shell_script_command" -> jsObjectShellScriptCommand(x))
        case x: com.hbc.svc.sundial.v1.models.BatchImageCommand => play.api.libs.json.Json.obj("batch_image_command" -> jsObjectBatchImageCommand(x))
        case x: com.hbc.svc.sundial.v1.models.EmrCommand => play.api.libs.json.Json.obj("emr_command" -> jsObjectEmrCommand(x))
        case x: com.hbc.svc.sundial.v1.models.TaskExecutableUndefinedType => sys.error(s"The type[com.hbc.svc.sundial.v1.models.TaskExecutableUndefinedType] should never be serialized")
      }
    }

    implicit def jsonWritesSvcSundialTaskExecutable: play.api.libs.json.Writes[TaskExecutable] = {
      new play.api.libs.json.Writes[com.hbc.svc.sundial.v1.models.TaskExecutable] {
...
package com.hbc.svc.sundial.v1 {
  ...
  object Bindables {
    ...
    object Models {
      ...
      val defaultEmrJobFlowRoleConverter: ApibuilderTypeConverter[com.hbc.svc.sundial.v1.models.DefaultEmrJobFlowRole] = new ApibuilderTypeConverter[com.hbc.svc.sundial.v1.models.DefaultEmrJobFlowRole] {
        override def convert(value: String): com.hbc.svc.sundial.v1.models.DefaultEmrJobFlowRole = com.hbc.svc.sundial.v1.models.DefaultEmrJobFlowRole(value)
        override def convert(value: com.hbc.svc.sundial.v1.models.DefaultEmrJobFlowRole): String = value.toString
        override def example: com.hbc.svc.sundial.v1.models.DefaultEmrJobFlowRole = com.hbc.svc.sundial.v1.models.DefaultEmrJobFlowRole.DefaultEmrJobFlowRole
        override def validValues: Seq[com.hbc.svc.sundial.v1.models.DefaultEmrJobFlowRole] = com.hbc.svc.sundial.v1.models.DefaultEmrJobFlowRole.all
      }
      implicit def pathBindableDefaultEmrJobFlowRole(implicit stringBinder: QueryStringBindable[String]): PathBindable[com.hbc.svc.sundial.v1.models.DefaultEmrJobFlowRole] = ApibuilderPathBindable(defaultEmrJobFlowRoleConverter)
      implicit def queryStringBindableDefaultEmrJobFlowRole(implicit stringBinder: QueryStringBindable[String]): QueryStringBindable[com.hbc.svc.sundial.v1.models.DefaultEmrJobFlowRole] = ApibuilderQueryStringBindable(defaultEmrJobFlowRoleConverter)

      val defaultEmrServiceRoleConverter: ApibuilderTypeConverter[com.hbc.svc.sundial.v1.models.DefaultEmrServiceRole] = new ApibuilderTypeConverter[com.hbc.svc.sundial.v1.models.DefaultEmrServiceRole] {
        override def convert(value: String): com.hbc.svc.sundial.v1.models.DefaultEmrServiceRole = com.hbc.svc.sundial.v1.models.DefaultEmrServiceRole(value)
        override def convert(value: com.hbc.svc.sundial.v1.models.DefaultEmrServiceRole): String = value.toString
        override def example: com.hbc.svc.sundial.v1.models.DefaultEmrServiceRole = com.hbc.svc.sundial.v1.models.DefaultEmrServiceRole.DefaultEmrServiceRole
        override def validValues: Seq[com.hbc.svc.sundial.v1.models.DefaultEmrServiceRole] = com.hbc.svc.sundial.v1.models.DefaultEmrServiceRole.all
      }
      implicit def pathBindableDefaultEmrServiceRole(implicit stringBinder: QueryStringBindable[String]): PathBindable[com.hbc.svc.sundial.v1.models.DefaultEmrServiceRole] = ApibuilderPathBindable(defaultEmrServiceRoleConverter)
      implicit def queryStringBindableDefaultEmrServiceRole(implicit stringBinder: QueryStringBindable[String]): QueryStringBindable[com.hbc.svc.sundial.v1.models.DefaultEmrServiceRole] = ApibuilderQueryStringBindable(defaultEmrServiceRoleConverter)

      val emrApplicationConverter: ApibuilderTypeConverter[com.hbc.svc.sundial.v1.models.EmrApplication] = new ApibuilderTypeConverter[com.hbc.svc.sundial.v1.models.EmrApplication] {
        override def convert(value: String): com.hbc.svc.sundial.v1.models.EmrApplication = com.hbc.svc.sundial.v1.models.EmrApplication(value)
        override def convert(value: com.hbc.svc.sundial.v1.models.EmrApplication): String = value.toString
        override def example: com.hbc.svc.sundial.v1.models.EmrApplication = com.hbc.svc.sundial.v1.models.EmrApplication.Hadoop
        override def validValues: Seq[com.hbc.svc.sundial.v1.models.EmrApplication] = com.hbc.svc.sundial.v1.models.EmrApplication.all
      }
      implicit def pathBindableEmrApplication(implicit stringBinder: QueryStringBindable[String]): PathBindable[com.hbc.svc.sundial.v1.models.EmrApplication] = ApibuilderPathBindable(emrApplicationConverter)
      implicit def queryStringBindableEmrApplication(implicit stringBinder: QueryStringBindable[String]): QueryStringBindable[com.hbc.svc.sundial.v1.models.EmrApplication] = ApibuilderQueryStringBindable(emrApplicationConverter)

      val emrReleaseLabelConverter: ApibuilderTypeConverter[com.hbc.svc.sundial.v1.models.EmrReleaseLabel] = new ApibuilderTypeConverter[com.hbc.svc.sundial.v1.models.EmrReleaseLabel] {
        override def convert(value: String): com.hbc.svc.sundial.v1.models.EmrReleaseLabel = com.hbc.svc.sundial.v1.models.EmrReleaseLabel(value)
        override def convert(value: com.hbc.svc.sundial.v1.models.EmrReleaseLabel): String = value.toString
        override def example: com.hbc.svc.sundial.v1.models.EmrReleaseLabel = com.hbc.svc.sundial.v1.models.EmrReleaseLabel.Emr5160
        override def validValues: Seq[com.hbc.svc.sundial.v1.models.EmrReleaseLabel] = com.hbc.svc.sundial.v1.models.EmrReleaseLabel.all
      }
      implicit def pathBindableEmrReleaseLabel(implicit stringBinder: QueryStringBindable[String]): PathBindable[com.hbc.svc.sundial.v1.models.EmrReleaseLabel] = ApibuilderPathBindable(emrReleaseLabelConverter)
      implicit def queryStringBindableEmrReleaseLabel(implicit stringBinder: QueryStringBindable[String]): QueryStringBindable[com.hbc.svc.sundial.v1.models.EmrReleaseLabel] = ApibuilderQueryStringBindable(emrReleaseLabelConverter)

      val notificationOptionsConverter: ApibuilderTypeConverter[com.hbc.svc.sundial.v1.models.NotificationOptions] = new ApibuilderTypeConverter[com.hbc.svc.sundial.v1.models.NotificationOptions] {
        override def convert(value: String): com.hbc.svc.sundial.v1.models.NotificationOptions = com.hbc.svc.sundial.v1.models.NotificationOptions(value)
        override def convert(value: com.hbc.svc.sundial.v1.models.NotificationOptions): String = value.toString
        override def example: com.hbc.svc.sundial.v1.models.NotificationOptions = com.hbc.svc.sundial.v1.models.NotificationOptions.Always
        override def validValues: Seq[com.hbc.svc.sundial.v1.models.NotificationOptions] = com.hbc.svc.sundial.v1.models.NotificationOptions.all
      }
      implicit def pathBindableNotificationOptions(implicit stringBinder: QueryStringBindable[String]): PathBindable[com.hbc.svc.sundial.v1.models.NotificationOptions] = ApibuilderPathBindable(notificationOptionsConverter)
      implicit def queryStringBindableNotificationOptions(implicit stringBinder: QueryStringBindable[String]): QueryStringBindable[com.hbc.svc.sundial.v1.models.NotificationOptions] = ApibuilderQueryStringBindable(notificationOptionsConverter)

      val onDemandConverter: ApibuilderTypeConverter[com.hbc.svc.sundial.v1.models.OnDemand] = new ApibuilderTypeConverter[com.hbc.svc.sundial.v1.models.OnDemand] {
        override def convert(value: String): com.hbc.svc.sundial.v1.models.OnDemand = com.hbc.svc.sundial.v1.models.OnDemand(value)
        override def convert(value: com.hbc.svc.sundial.v1.models.OnDemand): String = value.toString
        override def example: com.hbc.svc.sundial.v1.models.OnDemand = com.hbc.svc.sundial.v1.models.OnDemand.OnDemand
        override def validValues: Seq[com.hbc.svc.sundial.v1.models.OnDemand] = com.hbc.svc.sundial.v1.models.OnDemand.all
      }
      implicit def pathBindableOnDemand(implicit stringBinder: QueryStringBindable[String]): PathBindable[com.hbc.svc.sundial.v1.models.OnDemand] = ApibuilderPathBindable(onDemandConverter)
      implicit def queryStringBindableOnDemand(implicit stringBinder: QueryStringBindable[String]): QueryStringBindable[com.hbc.svc.sundial.v1.models.OnDemand] = ApibuilderQueryStringBindable(onDemandConverter)

      val processOverlapActionConverter: ApibuilderTypeConverter[com.hbc.svc.sundial.v1.models.ProcessOverlapAction] = new ApibuilderTypeConverter[com.hbc.svc.sundial.v1.models.ProcessOverlapAction] {
        override def convert(value: String): com.hbc.svc.sundial.v1.models.ProcessOverlapAction = com.hbc.svc.sundial.v1.models.ProcessOverlapAction(value)
        override def convert(value: com.hbc.svc.sundial.v1.models.ProcessOverlapAction): String = value.toString
        override def example: com.hbc.svc.sundial.v1.models.ProcessOverlapAction = com.hbc.svc.sundial.v1.models.ProcessOverlapAction.Wait
        override def validValues: Seq[com.hbc.svc.sundial.v1.models.ProcessOverlapAction] = com.hbc.svc.sundial.v1.models.ProcessOverlapAction.all
      }
      implicit def pathBindableProcessOverlapAction(implicit stringBinder: QueryStringBindable[String]): PathBindable[com.hbc.svc.sundial.v1.models.ProcessOverlapAction] = ApibuilderPathBindable(processOverlapActionConverter)
      implicit def queryStringBindableProcessOverlapAction(implicit stringBinder: QueryStringBindable[String]): QueryStringBindable[com.hbc.svc.sundial.v1.models.ProcessOverlapAction] = ApibuilderQueryStringBindable(processOverlapActionConverter)

      val processStatusConverter: ApibuilderTypeConverter[com.hbc.svc.sundial.v1.models.ProcessStatus] = new ApibuilderTypeConverter[com.hbc.svc.sundial.v1.models.ProcessStatus] {
        override def convert(value: String): com.hbc.svc.sundial.v1.models.ProcessStatus = com.hbc.svc.sundial.v1.models.ProcessStatus(value)
        override def convert(value: com.hbc.svc.sundial.v1.models.ProcessStatus): String = value.toString
        override def example: com.hbc.svc.sundial.v1.models.ProcessStatus = com.hbc.svc.sundial.v1.models.ProcessStatus.Running
        override def validValues: Seq[com.hbc.svc.sundial.v1.models.ProcessStatus] = com.hbc.svc.sundial.v1.models.ProcessStatus.all
      }
      implicit def pathBindableProcessStatus(implicit stringBinder: QueryStringBindable[String]): PathBindable[com.hbc.svc.sundial.v1.models.ProcessStatus] = ApibuilderPathBindable(processStatusConverter)
      implicit def queryStringBindableProcessStatus(implicit stringBinder: QueryStringBindable[String]): QueryStringBindable[com.hbc.svc.sundial.v1.models.ProcessStatus] = ApibuilderQueryStringBindable(processStatusConverter)

      val taskStatusConverter: ApibuilderTypeConverter[com.hbc.svc.sundial.v1.models.TaskStatus] = new ApibuilderTypeConverter[com.hbc.svc.sundial.v1.models.TaskStatus] {
        override def convert(value: String): com.hbc.svc.sundial.v1.models.TaskStatus = com.hbc.svc.sundial.v1.models.TaskStatus(value)
        override def convert(value: com.hbc.svc.sundial.v1.models.TaskStatus): String = value.toString
        override def example: com.hbc.svc.sundial.v1.models.TaskStatus = com.hbc.svc.sundial.v1.models.TaskStatus.Submitted
        override def validValues: Seq[com.hbc.svc.sundial.v1.models.TaskStatus] = com.hbc.svc.sundial.v1.models.TaskStatus.all
      }
      implicit def pathBindableTaskStatus(implicit stringBinder: QueryStringBindable[String]): PathBindable[com.hbc.svc.sundial.v1.models.TaskStatus] = ApibuilderPathBindable(taskStatusConverter)
      implicit def queryStringBindableTaskStatus(implicit stringBinder: QueryStringBindable[String]): QueryStringBindable[com.hbc.svc.sundial.v1.models.TaskStatus] = ApibuilderQueryStringBindable(taskStatusConverter)
    }
