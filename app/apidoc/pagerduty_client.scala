 ...
 * apidoc:0.11.52 http://www.apidoc.me/speedwing/pagerduty-api/0.0.1-dev/play_2_3_client
 */
...
package speedwing.pagerduty.api.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.52 http://www.apidoc.me/speedwing/pagerduty-api/0.0.1-dev/play_2_3_client"
    ...
    object CreateEvents extends CreateEvents {
      override def post(
        ...
        _executeRequest("POST", s"/generic/2010-04-15/create_event.json", body = Some(payload), requestHeaders = requestHeaders).map {
          case r if r.status == 200 => _root_.speedwing.pagerduty.api.v0.Client.parseJson("String", r, _.validate[String])
