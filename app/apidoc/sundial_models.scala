 ...
 * apibuilder:0.13.0 https://app.apibuilder.io/gilt/svc-sundial/0.2.1/play_2_x_json
 */
  ...
  package object json {
    ...
    implicit def jsonReadsSvcSundialEmrCommand: play.api.libs.json.Reads[EmrCommand] = {
      (
        ...
        (__ \ "s3_log_details").readNullable[com.gilt.svc.sundial.v0.models.S3LogDetails]
      )(EmrCommand.apply _)
    }
