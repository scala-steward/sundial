...
trait ProcessDefinitionDao {
  ...
  def deleteTaskDefinitionTemplate(processDefinitionName: String,
                                   taskDefinitionName: String): Boolean
}
